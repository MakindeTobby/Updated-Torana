                    ...
                    <div className="hero-text hero-text-2 pt-35">
                      <div className="hero-slider-caption hero-slider-caption-2">
                        ...
                        <h1 className="white-color">
                          Best Care & Best Carers.
                        </h1>
                      </div>
                      <div className="hero-slider-btn">
                        <Link
                          to="/about"
                          className="primary_btn btn-icon btn-icon-blue ml-0"
                        >
                          <span>+</span>about us
                        </Link>
                        <button
                        ...
                        <div className="row">
                            ...
                            <div className="appoinment-form-box appoinment-form-box-option d-flex mb-40">
                              ...
                              <form className="appointment-form-2" action="#">
                                ...
                                <select
                                  name="lc"
                                  id="lc"
                                  className="postform w-100 overflow-hidden border-0"
                                  onChange={(e) => setLocation(e.target.value)}
                                >
                                  <option defaultValue="-1" hidden>
                                    Choose a Location
                                  </option>
                                  <option className="level-0" defaultValue="36">
                                    Australian Capital Territory
                                  </option>
                                  <option className="level-0" defaultValue="36">
                                    New South Wales
                                  </option>
                                  <option className="level-0" defaultValue="37">
                                    Victoria
                                  </option>
                                  <option className="level-0" defaultValue="38">
                                    Queensland
                                  </option>
                                  <option className="level-0" defaultValue="39">
                                    Northern Territory
                                  </option>
                                  <option className="level-0" defaultValue="39">
                                    Western Australia
                                  </option>
                                  <option className="level-0" defaultValue="40">
                                    South Australia
                                  </option>
                                  <option className="level-0" defaultValue="40">
                                    Tasmania
                          ...
                          <div className="col-xl-12 mb-35">
                            <div className="inner caregive-btn text-center">
                              <button
                                onClick={goTo}
                                className="primary_btn rounded-pill"
                              >
                                Make Appointment
                              </button>
                            </div>
