              ...
              <div className="row align-items-center">
                <div className="col-xl-4 col-lg-4 col-md-4">
                  <div className="footer-logo-2">
                    <Link to="/">
                      <img src="img/logo/new-logo.png" alt="" width={"50%"} />
                    </Link>
                  </div>
                </div>
                    ...
                    <div className="footer-contact-info-2">
                      <div className="f-contact-info-box fix mb-30">
                        ...
                        <div className="footer-co-content">
                          ...
                          <a href="tel:+610261098099">
                            <h4>+61 026 109 8099</h4>
                          </a>
                        </div>
                      </div>
                      <div className="f-contact-info-box fix mb-30">
                        ...
                        <div className="footer-co-content">
                          ...
                          <a href="mailto:info@toranacareaustralia.com.au">
                            <h5 className="text-white">
                              info@toranacareaustralia.com.au
                            </h5>
                          </a>
                        </div>
                      </div>
                      <div className="f-contact-info-box fix mb-30">
                        ...
                        <div className="footer-co-content">
                          ...
                          <ul>
                            <li>
                              <a href="https://web.facebook.com/Toranacareaustralia?_rdc=1&_rdr">
                                <i className="fab fa-facebook-f"></i>
                              </a>
                            </li>
                            {/* <li><a href="#"><i className="fab fa-behance"></i></a></li> */}
                            <li>
                              <a href="https://www.linkedin.com/in/torana-care-australia-baa2571a9/">
                ...
                <div className="col-xl-4 col-lg-6 col-md-6">
                  <div className="footer-widget mb-40">
                    ...
                    <div className="footer-menu footer-menu-2 fix">
                      <ul>
                        <li>
                          <a href="https://www.xero.com/au">Xero Login</a>
                        </li>
                        <li>
                          <a href="https://1467a717015014.au.deputy.com/login?noredirechrefnce=1">
                            Deputy Scheduling
                          </a>
                        </li>
                        <li>
                          <a href="https://workpro.com.au">Work pro login</a>
                        </li>
                        <li>
                ...
                <div className="col-xl-4 col-lg-6 col-md-6">
                  <div className="footer-widget mb-40">
                    <div className="footer-menu footer-menu-2 fix">
                      <ul>
                        <li>
                          <Link to="/covid19-updates">Covid-19 Updates</Link>
                        </li>
                        <li>
                        ...
                        <li>
                          <Link to="/services">Registered NDIS Provider</Link>
                        </li>
                        <li>
                          <Link to="/contact">Comment and Feedback</Link>
                        </li>
                        <li>
                          <Link to="/blog">Blog</Link>
                        </li>
                        <li>
                          <Link to="/contact#maps">Guides</Link>
                        </li>
                        <li>
                  ...
                  <div className="footer-copyright-area text-center">
                    <p className="text-white">
                      ...
                      <Link to={"/"} className="white-color">
                        {" "}
                        Torana Care Australia. <strong></strong>{" "}
                      </Link>
                      All rights reserved
                    </p>
                  </div>
