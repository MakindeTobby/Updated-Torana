         ...
         <section className="blog-area pt-100 pb-60">
            <div className="container">
               <div className="row">
                  ...
                  <BlogSmSingleColumn image="1" column="4" title="Positive Thinking a powerful act" content="Life can be hard especially when we are faced with multiple health 
...
"
                  ...
                  <BlogSmSingleColumn image="2" column="4" title="Appreciate You"
                     ...
                     content="Being alive comes with lots of challenges. Every individual, both Able or Disable face difficulties. Some challenges are physical,.... 
